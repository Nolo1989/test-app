<template>
	<section class="large-game">
		<div class="first-square">
			...
			<div class="column-11">
				<div class="field" :class="$attrs.themeColor">Y</div>
				<div class="field large"></div>
				<div class="field result" :class="$attrs.themeColor">{{ firstSquareSumTotal }}</div>
			</div>
		</div>
		<div class="second-square">
			...
			<div class="column-11">
				<div class="field large"></div>
				<div class="field result" :class="$attrs.themeColor">{{ secondSquareSumTotal }}</div>
			</div>
		</div>
		<div class="third-square">
			...
			<div class="column-11">
				...
				<div class="field result" :class="$attrs.themeColor">{{ thirdSquareSumTotal }}</div>
			</div>
		</div>
